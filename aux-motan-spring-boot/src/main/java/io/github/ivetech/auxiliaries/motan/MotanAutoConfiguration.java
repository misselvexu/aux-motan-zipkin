...
import io.github.ivetech.auxiliaries.motan.properties.BasicRefererConfigProperties;
import io.github.ivetech.auxiliaries.motan.properties.BasicServiceConfigProperties;
import io.github.ivetech.auxiliaries.motan.properties.ProtocolConfigProperties;
import io.github.ivetech.auxiliaries.motan.properties.RegistryConfigProperties;
import io.github.ivetech.auxiliaries.motan.support.BasicServiceConfigCondition;
...
public class MotanAutoConfiguration {
    ...
    /**
    @Bean(name = "opentracingContext")
    public OpenTracingContext openTracingContext (@Value("${motan.zipkin.host}") String host,
                                                  @Value("${motan.zipkin.application}") String traceName) {
        OpenTracingContext openTracingContext = new OpenTracingContext();
        openTracingContext.setTracerFactory(new ZipkinTraceFactory(host, traceName));
    ...
    **/                                              
     ...
     * 属性来自Motan的配置文档
     *
     * @see <code>https://github.com/weibocom/motan/blob/master/docs/wiki/zh_configuration.md</code>
     * <p>
